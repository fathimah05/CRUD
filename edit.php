...
<div class="bg-grey-200 rounded-xl p-4">
                ...
                <form action="" method="post">
                    <div class="mb-3 bg-pink-500 rounded-lg p-4 m-3">
                        ...
                        <div class="grid gap-2">
                           <button name="submit" class="bg-pink-400 hover:bg-pink-800 p-3 m-4 rounded-lg text-white" type="submit">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
